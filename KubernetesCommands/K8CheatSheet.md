...
## Interacting with Deployments and Service
...
List all supported resource types along with the shortnames, API group, weather they are namespaced, and Kind:
...
|------------|-----------|
|`-o=custom-columns=<spec>`|Print a table using a comma seprated list of custom columns|
